                ...
                <div className="flex justify-center">
                    <div className="rounded-lg shadow-lg bg-white max-w-sm">
                        ...
                        <div className="p-6">
                            ...
                            <Link to='https://warehouse-management-cli-2f12c.web.app/' className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Live site</Link>
                        </div>
                    </div>
                    </div>
                    </AnimationOnScroll>
...
{/* // service_teha4ci */}
              ...
              <div className="flex justify-center">
                    <div className="rounded-lg shadow-lg bg-white max-w-sm">
                            <img className="rounded-t-lg hover:scale-125 transition duration-300 ease-in-out" src="https://cdn.shopify.com/s/files/1/1706/9177/products/imac-24-blue-gallery-2_71cd39ed-88bc-446b-bc36-a1a46eaa3b47.jpg?v=1635953262" alt="" />
                        <div className="p-6">
                            ...
                            <Link to='https://iridescent-mooncake-ef1f54.netlify.app/' className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Live site</Link>
                        </div>
                    </div>
                    </div>
              </AnimationOnScroll>
