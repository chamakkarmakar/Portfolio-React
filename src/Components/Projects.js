                        ...
                        <div className="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div className="p-6">
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <a href='https://github.com/chamakkarmakar/warehouse-management-client' target="_blank" rel="noreferrer" className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Client</a>
                                    <a href='https://github.com/chamakkarmakar/warehouse-management-server' target="_blank" rel="noreferrer" className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Server</a>
                        ...
                        <div className="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div className="p-6">
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <a href='https://github.com/chamakkarmakar/independent-service-provider' target="_blank" rel="noreferrer" className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div className="p-6">
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <a href='https://github.com/chamakkarmakar/product-analysis-review/' target="_blank" rel="noreferrer" className=" inline-block px-6 py-2.5 my-5 bg-rose-600 text-white font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-rose-700 hover:shadow-lg focus:bg-rose-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-rose-800 active:shadow-lg transition duration-150 ease-in-out" >Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
